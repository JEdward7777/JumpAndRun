...
class WalkyBadguy extends Badguy{
  ...
  public String save(){
    return "   walky( " + (loc.x/block_size.x) + ", " + (loc.y/block_size.y) + ", " + this.speed.x + " );";
  }
}
